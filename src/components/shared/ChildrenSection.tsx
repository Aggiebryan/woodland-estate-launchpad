              ...
              <CardContent className="pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => onChildChange(index, "middleName", e.target.value)}
                      className="text-white"
                    />
                  </div>
                  <div>
                ...
                <div className="mb-4">
                  ...
                  <RadioGroup 
                    ...
                    onValueChange={(value) => onChildRadioChange(index, "relationship", value)}
                ...
                {child.relationship === "previousMarriage" && (
                  <div className="mb-4">
                    <Label htmlFor={`child-${index}-otherParent`} className="text-woodlands-gold">Other Parent's Name</Label>
                    <Input
                      id={`child-${index}-otherParent`}
                      value={child.otherParentName}
                      onChange={(e) => onChildChange(index, "otherParentName", e.target.value)}
                      className="text-white"
                    />
                  </div>
                )}
                ...
                <div className="mb-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id={`child-${index}-livesWithClient`}
                      checked={child.livesWithClient}
                      onCheckedChange={(checked) => onChildCheckboxChange(index, "livesWithClient", !!checked)}
                    />
                ...
                {!child.livesWithClient && (
                  <div className="space-y-4 border-t border-woodlands-gold/20 pt-4 mt-4">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        ...
                        <Input
                          id={`child-${index}-street`}
                          value={child.address.street}
                          onChange={(e) => onChildAddressChange(index, "street", e.target.value)}
                          className="text-white"
                        />
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => onChildAddressChange(index, "city", e.target.value)}
                          className="text-white"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => onChildAddressChange(index, "state", e.target.value)}
                          className="text-white"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          id={`child-${index}-zipCode`}
                          value={child.address.zipCode}
                          onChange={(e) => onChildAddressChange(index, "zipCode", e.target.value)}
                          className="text-white"
                        />
                      </div>
                    </div>
                ...
                <div className="mt-4 flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => onChildCheckboxChange(index, "isMinor", !!checked)}
                  />
