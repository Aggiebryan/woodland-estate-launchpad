          ...
          <Card className="bg-woodlands-darkpurple border-woodlands-gold/20">
            <CardContent className="pt-6">
              <p className="text-woodlands-cream mb-4">
                The Woodlands Law Firm is committed to providing exceptional legal services in estate planning, probate, and related areas of law. Our team of experienced attorneys brings together diverse backgrounds and expertise to serve our clients with dedication and integrity.
              </p>
              <p className="text-woodlands-cream">
                Located in the heart of The Woodlands, we take pride in being an integral part of our community, helping families and individuals protect their legacies and plan for the future. Our approach combines professional excellence with personal attention, ensuring that each client receives tailored solutions for their unique needs.
              </p>
            </CardContent>
          </Card>
        </section>
